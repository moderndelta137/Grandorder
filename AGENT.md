...
## My Idea
I want to make a HTML adventure rpg based on 聖杯戦争 descripted in Fate Stay Night and Fate Zero. The game should strictly adapt rules from the 聖杯戦争 and focus on making meaningful decisions based on the character you are curretly role playing. The game should be in Japanese and all concept should be using their proper Japanese names.
I want the game to have elegent and detailed graphic style with fluid and beautiful visual effect. The game should be themed with a magical fantasy happend in modern day. 
